        ...
        <div class="relative overflow-x-auto mt-4 bg-white w-full rounded-lg px-6 py-4">
            ...
            <div class="grid grid-cols-2 gap-5">
                    ...
                    <div class="mb-5 w-full">
                        ...
                        <input type="email" name="email" class="bg-gray-100 border-[1px] py-3 px-6  rounded-lg w-full  @error('email') border-red-500 @enderror" placeholder="name@example.com" value="{{ old('email') }}"/>
                        @error('email')
                            <p class="text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-5 w-full">
                        ...
                        <div class="grid grid-cols-3">
                            @foreach ($roles as $role)
                                <div>
                                    <input type="checkbox" value="{{ $role->id }}" name="roles[]" {{ old('roles[]') == $role->id ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
