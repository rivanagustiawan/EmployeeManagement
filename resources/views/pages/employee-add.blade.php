                    ...
                    <div class="mb-5 w-full">
                        ...
                        <div class="grid grid-cols-3">
                            @foreach ($roles as $role)
                                <div>
                                    <input type="checkbox" value="{{ $role->id }}" name="roles[]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
